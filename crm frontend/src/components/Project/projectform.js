...
function Projectform() {
  ...
  const checkForDuplicates = async (contacts) => {
    try {
      ...
      const allunits = response.data.project.flatMap(
        (project) => project.add_unit
      );
    ...
    <div>
            ...
            <div className="col-md-12 border-right">
              <div className="p-3 py-5">
                ...
                >
                  ...
                  <div className="col-md-2  custom-input" id="totalfloors">
                          ...
                          >
                            <div className="col-md-3  custom-input">
                              ...
                              <input
                                ...
                                className="form-control form-control-sm"
                                onChange={(e) =>
                                  setsizes({ ...sizes, length: e.target.value })
                                }
                              />
                            </div>
                            <div className="col-md-3  custom-input">
                              ...
                              <select
                                className="form-control form-control-sm"
                                onChange={(e) =>
                                  setsizes({ ...sizes, yard1: e.target.value })
                                }
                              >
                                <option>---select---</option>
                                <option>Yard</option>
                            ...
                            <div className="col-md-3  custom-input">
                              ...
                              <input
                                ...
                                className="form-control form-control-sm"
                                onChange={(e) =>
                                  setsizes({ ...sizes, bredth: e.target.value })
                                }
                              />
                            </div>
                            <div className="col-md-3  custom-input">
                            ...
                            <div className="col-md-3  custom-input">
                              ...
                              <select
                                className="form-control form-control-sm"
                                onChange={(e) =>
                                  setsizes({ ...sizes, yard3: e.target.value })
                                }
      ...
      <div className="popup-container">
        <div className="popup">
          ...
          <div
            className="row"
            style={{ marginLeft: "50%", marginBottom: "20px" }}
          >
