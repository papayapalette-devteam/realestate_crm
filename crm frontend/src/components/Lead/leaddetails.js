...
function Leadfetch() {
  ...
  // useEffect(()=>{fetchdata()},[])
  useEffect(() => {
    fetchdatabystage_incomingcount();
  }, []);
  useEffect(() => {
    fetchdatabystage_prospectcount();
  }, []);
  useEffect(() => {
    fetchdatabystage_Negotiationcount();
  }, []);
  useEffect(() => {
    fetchdatabystage_woncount();
  }, []);
  useEffect(() => {
    fetchdatabystage_lostcount();
  }, []);
  useEffect(() => {
    fetchdatabystage_opportunitycount();
  }, []);
  ...
  useEffect(() => {
    const updateLeadsAndRefresh = async () => {
      if (!data || data.length === 0 || hasRunRef.current) return; // skip if no data or already ran

      try {
        setIsLoading(true);

        // Call backend to update matched deals
        const resp = await api.post("/matched-deals", { leads: data });
    ...
    updateLeadsAndRefresh();
  }, [data]); // ⚡ run whenever data changes, but effect executes only once
  ...
  const get_group_data = async () => {
    try {
      const resp = await api.get("get-grouped-data");
  ...
  const contactfields = [
    ...
    { label: "Returning Date", field: "returning_date", type: "date-range" },
    ...
    {
      label: "Converted Contact Date",
      field: "converted_contact_date",
      type: "date-range",
    },

    { label: "Lead Stage", field: "stage", values: groupdata?.lead_stages },
    {
      label: "Requirement",
      field: "requirment",
      values: groupdata?.requirements,
    },
    { label: "City", field: "city1", values: groupdata?.cities },
    { label: "Location", field: "location1", values: groupdata?.locations },
    { label: "Property Type", field: "property_type" }, // Added field for from date
    { label: "Property Sub Type", field: "sub_type" },
    { label: "Budget", field: "budget", values: groupdata?.budget_range },
    { label: "Size", field: "size", values: groupdata?.size_range },
    { label: "Campaign", field: "campaign", values: groupdata?.campaigns },
    { label: "Source", field: "source", values: groupdata?.sources },
    { label: "Lead Type", field: "lead_type", values: groupdata?.lead_types },
    {
      label: "Channel Partner",
      field: "channel_partner",
      values: groupdata?.channel_partners,
    },
  ];
  ...
  const fetchdatabystage_incoming = async () => {
    try {
      ...
      setdata(
        Array.isArray(resp.data.lead) ? resp.data.lead : [resp.data.lead]
      );
    } catch (error) {
      console.log(error);
    }
  ...
  const fetchdatabystage_prospectcount = async () => {
    try {
      const resp = await api.get(`viewleadbystage/Prospect`);
      const prospect = Array.isArray(resp.data.lead)
        ? resp.data.lead
        : [resp.data.lead];
  ...
  const fetchdatabystage_Negotiationcount = async () => {
    try {
      const resp = await api.get(`viewleadbystage/Negotiation`);
      const negotiation = Array.isArray(resp.data.lead)
        ? resp.data.lead
        : [resp.data.lead];
  ...
  const fetchdatabystage_woncount = async () => {
    try {
      ...
      const Won = Array.isArray(resp.data.lead)
        ? resp.data.lead
        : [resp.data.lead];
  ...
  const fetchdatabystage_lostcount = async () => {
    try {
      ...
      const Lost = Array.isArray(resp.data.lead)
        ? resp.data.lead
        : [resp.data.lead];
  ...
  function addFn11() {
    setleadinfo({
      ...
      action11: Array.isArray(leadinfo.action11)
        ? [...leadinfo.action11, ""]
        : [""],
    });
  }
  ...
  function addFn22() {
    setleadinfo({
      ...
      action22: Array.isArray(leadinfo.action22)
        ? [...leadinfo.action22, ""]
        : [""],
    });
  }
  ...
  function addFn3() {
    setleadinfo((prevlead) => ({
      ...
      action3: Array.isArray(prevlead.action3)
        ? [...prevlead.action3, ""]
        : [""],
    }));
  }
  const deleteall3 = (index) => {
    const newcomapnysocialmedia = leadinfo.company_social_media.filter(
      (_, i) => i !== index
    );
  ...
  function addFn4() {
    setleadinfo((prevlead) => ({
      ...
      action4: Array.isArray(prevlead.action4)
        ? [...prevlead.action4, ""]
        : [""],
    }));
  }
  ...
  function addFn5() {
    setleadinfo((prevlead) => ({
      ...
      action5: Array.isArray(prevlead.action5)
        ? [...prevlead.action5, ""]
        : [""],
    }));
  }
  ...
  function addFn6() {
    setleadinfo((prevlead) => ({
      ...
      url: [...prevlead.url, ""],
      action6: Array.isArray(prevlead.action6)
        ? [...prevlead.action6, ""]
        : [""],
    }));
  }
  ...
  function addFn7() {
    setleadinfo((prevlead) => ({
      ...
      action7: Array.isArray(prevlead.action7)
        ? [...prevlead.action7, ""]
        : [""],
    }));
  }
  ...
  function addFn8() {
    setleadinfo((prevlead) => ({
      ...
      action8: Array.isArray(prevlead.action8)
        ? [...prevlead.action8, ""]
        : [""],
    }));
  }
  ...
  const deleteall81 = (index) => {
    const newdocumentno = leaddocument.document_no.filter(
      (_, i) => i !== index
    );
    const newdocumentname = leaddocument.document_name.filter(
      (_, i) => i !== index
    );
    const newdocumentpic = leaddocument.document_pic.filter(
      (_, i) => i !== index
    );
  ...
  const allproject = [];
  data11.map((item) => allproject.push(item.name));
  ...
  const getAvailableunittype = () => {
    ...
    if (Array.isArray(leadinfo.sub_type)) {
      return leadinfo.sub_type.flatMap((cat) =>
        Array.isArray(options.unit_type[cat]) ? options.unit_type[cat] : []
      );
    }
  ...
  const getAvailableSubcategories = () => {
    if (Array.isArray(leadinfo.property_type)) {
      return leadinfo.property_type.flatMap((cat) =>
        Array.isArray(options.sub_type[cat]) ? options.sub_type[cat] : []
      );
    }
  ...
  //               deal.available_for === availableFor &&
  //               (number(deal.expected_price) >= minprice && number(deal.expected_price) <= maxprice) &&
  //                 // (propertytype && unitData.category && propertytype.some(pt => unitData.category.includes(pt))) &&
  //                 // (subtype && unitData.sub_category && subtype.includes(unitData.sub_category)) &&
  //                 // (unit_type.includes(unittype)) &&
  //               (
  ...
  const handleMatchLeadClick = async (item) => {
    try {
      ...
      for (const deal of item.matcheddeals) {
        ...
        if (!unitData) {
          console.warn(
            `No unit found for: Project=${deal.project}, Block=${deal.block}, Unit=${deal.unit_number}`
          );
          continue;
        }
        ...
        if (item.specific_unit && item.specific_unit.trim() === unit)
          matchScore += 10;
        ...
        if (
          size >= parseFloat(item.minimum_area) &&
          size <= parseFloat(item.maximum_area)
        )
          matchScore += 5;
  ...
  const leadCity = lead1[0]?.city3?.trim()
    ? lead1[0]?.city3.toLowerCase().trim()
    : lead1[0]?.city2?.toLowerCase().trim() || "";
  ...
  useEffect(() => {
    ...
    for (const deal of matcheddeals) {
      const unitInfo = allunitsdetails.find(
        (u) =>
          u.unitData?.project_name?.toLowerCase().trim() ===
            deal.project?.toLowerCase().trim() &&
          u.unitData?.unit_no?.toString().trim() ===
            deal.unit_number?.toString().trim() &&
          u.unitData?.block?.toLowerCase().trim() ===
            deal.block?.toLowerCase().trim()
      );
  ...
  useEffect(() => {
    ...
    const matcheddetails = sendmatchingdeals
      .map((property, index) => {
        const unitInfo = allunitsdetails.find(
          (u) =>
            u.unitData?.project_name?.toLowerCase().trim() ===
              property.project?.toLowerCase().trim() &&
            u.unitData?.unit_no?.toString().trim() ===
              property.unit_number?.toString().trim() &&
            u.unitData?.block?.toLowerCase().trim() ===
              property.block?.toLowerCase().trim()
        );
        ...
        const propertyIcon = unitData?.sub_category.includes(
          "Independent House"
        )
          ? "🏠"
        ...
        const formattedDetails = `
                    <b>${index + 1}. ${propertyIcon} ${
          unitData?.size || "N/A"
        } ${unitData?.sub_category || "N/A"}</b>
  ...
  useEffect(() => {
    if (Array.isArray(lead1) && lead1.length > 0) {
      ...
      const subjectText = `${title || ""} ${first_name || ""} ${
        last_name || ""
      } – We've Found Multiple Properties Matching Your Requirements – Take a Look!`;
  ...
  const handleTemplateSelect1 = (e) => {
    ...
    const dealsHtml = propertyDetailsList
      .map(
        (deal, index) =>
          `<strong>${index + 1}.</strong> ` +
          replaceVariables(dealBlock, lead, deal)
      )
      .join("<br></br>");
  ...
  const replaceVariables = (template, lead, property) => {
    ...
    return template
      ...
      .replace(
        /{{location}}/g,
        property?.location ? `${property.location}` : "not available"
      )
      .replace(
        /{{price}}/g,
        property?.price
      ...
      .replace(
        /{{direction}}/g,
        property?.facing
          ? `<strong>Direction:</strong> ${property.direction}`
          : "not available"
      )
      .replace(
        /{{road}}/g,
        property?.facing
          ? `<strong>Road:</strong> ${property.road}`
          : "not available"
      )
      .replace(
        /{{registry}}/g,
        property?.registry
          ? `<strong>Registry:</strong> ${property.registry}`
          : "not available"
      )
      .replace(
        /{{ownership}}/g,
      ...
      .replace(
        ...
        property?.project_name
          ? `<strong>Project Name:</strong> ${property.project_name}`
          : "not available"
      )
      .replace(
        /{{unit_no}}/g,
        property?.unit_no
          ? `<strong>Unit No:</strong> ${property.unit_no}`
          : "not available"
      )
      .replace(
        /{{unit_type}}/g,
      ...
      .replace(
        /{{stage}}/g,
        property?.stage
          ? `<strong>Stage:</strong> ${property.stage}`
          : "not available"
      )
      .replace(
        /{{floor}}/g,
      ...
      .replace(
        /{{cluter_details}}/g,
        Array.isArray(property?.cluter_details) &&
          property.cluter_details.length > 0
      ...
      .replace(
        /{{length}}/g,
        Array.isArray(property?.length) && property.length.length > 0
          ? `<strong>Length:</strong> ${property.length.join(", ")}`
          : "not available"
      )
      .replace(
        /{{bredth}}/g,
        Array.isArray(property?.bredth) && property.bredth.length > 0
          ? `<strong>Bredth:</strong> ${property.bredth.join(", ")}`
          : "not available"
      )
      .replace(
        /{{total_area}}/g,
        Array.isArray(property?.total_area) && property.total_area.length > 0
          ? `<strong>Total Area:</strong> ${property.total_area.join(", ")}`
          : "not available"
      )
      .replace(
        /{{measurment2}}/g,
        Array.isArray(property?.measurment2) && property.measurment2.length > 0
          ? `<strong>Measurment:</strong> ${property.measurment2.join(", ")}`
          : "not available"
      )
      .replace(
        /{{ocupation_date}}/g,
        property?.ocupation_date
          ? `<strong>Ocupation Date:</strong> ${property.ocupation_date}`
          : "not available"
      )
      .replace(
        /{{age_of_construction}}/g,
        property?.age_of_construction
          ? `<strong>Age Of Construction:</strong> ${property.age_of_construction}`
          : "not available"
      )
      .replace(
        /{{furnishing_details}}/g,
        property?.furnishing_details
          ? `<strong>Furnishing Details:</strong> ${property.furnishing_details}`
          : "not available"
      )
      .replace(
        /{{furnished_item}}/g,
        property?.furnished_item
          ? `<strong>Furnished Item:</strong> ${property.furnished_item}`
          : "not available"
      )
      .replace(
        /{{lattitude}}/g,
        property?.lattitude
          ? `<strong>Lattitude:</strong> ${property.lattitude}`
          : "not available"
      )
      .replace(
        /{{langitude}}/g,
        property?.langitude
          ? `<strong>Langitude:</strong> ${property.langitude}`
          : "not available"
      )
      .replace(
        /{{uaddress}}/g,
        property?.uaddress
          ? `<strong>Address:</strong> ${property.uaddress}`
          : "not available"
      )
      .replace(
        /{{ustreet}}/g,
        property?.ustreet
          ? `<strong>Street:</strong> ${property.ustreet}`
          : "not available"
      )
      .replace(
        /{{ulocality}}/g,
        property?.ulocality
          ? `<strong>Locality:</strong> ${property.ulocality}`
          : "not available"
      )
      .replace(
        /{{ucity}}/g,
        property?.ucity
          ? `<strong>City:</strong> ${property.ucity}`
          : "not available"
      )
      .replace(
        /{{uzip}}/g,
        property?.uzip
          ? `<strong>Zip:</strong> ${property.uzip}`
          : "not available"
      )
      .replace(
        /{{ustate}}/g,
        property?.ustate
          ? `<strong>Project Name:</strong> ${property.ustate}`
          : "not available"
      )
      .replace(
        /{{ucountry}}/g,
        property?.ucountry
          ? `<strong>Country:</strong> ${property.ucountry}`
          : "not available"
      )
      .replace(
        /{{relation}}/g,
        property?.relation
          ? `<strong>Relation:</strong> ${property.relation}`
          : "not available"
      )
      .replace(
        /{{owner_details}}/g,
        Array.isArray(property?.owner_details) &&
          property.owner_details.length > 0
      ...
      .replace(
        /{{associated_contact}}/g,
        Array.isArray(property?.associated_contact) &&
          property.associated_contact.length > 0
      ...
      .replace(
        /{{previousowner_details}}/g,
        Array.isArray(property?.previousowner_details) &&
          property.previousowner_details.length > 0
  ...
  const fetchsearchdata = async (page, limit, search) => {
    try {
      ...
      const resp = await api.get(
        `/searchlead?page=${page}&limit=${limit}&search=${encodeURIComponent(
          search
        )}`
      );
    ...
    try {
      ...
      response.data.lead.forEach((existing) => {
        if (Array.isArray(existing.mobile_no)) {
          existing.mobile_no.forEach((num) =>
            existingMobileNos.add(String(num).trim())
          );
  ...
  const addcontact = async (e) => {
    ...
    try {
      ...
      for (let i = 0; i < total; i += batchSize) {
        ...
        try {
          ...
          if (resp1.status === 200 && resp2.status === 200) {
            ...
            toast.success(`Imported ${successCount}/${total} leads`, {
              autoClose: 2000,
            });
          } else {
            failCount += batch.length;
            toast.error(`Batch ${i + 1}-${i + batch.length} failed`, {
              autoClose: 2000,
            });
          }
        } catch (batchError) {
          failCount += batch.length;
          toast.error(`Error importing batch ${i + 1}-${i + batch.length}`, {
            autoClose: 3000,
          });
        }
      }
      ...
      Swal.fire({
        ...
        title: "Import Failed",
        text:
          `${error?.response?.data?.message} also check your excel file. unwanted coma or unwant - if your are using it.` ||
    ...
    try {
      ...
      for (let i = 0; i < total; i += batchSize) {
        ...
        try {
          ...
          if (resp1.status === 200 && resp2.status === 200) {
            successCount += batch.length;
            toast.success(`Updated ${successCount}/${total} leads`, {
              autoClose: 2000,
            });
          } else {
            failCount += batch.length;
          ...
          failCount += batch.length;
          toast.error(`Error updating batch ${i + 1}-${i + batch.length}`, {
            autoClose: 3000,
          });
        }
      }
  ...
  return (
    ...
    overflow-y-auto overflow-x-auto`}
        ...
        <button
          ...
          style={{ width: "120px", marginLeft: "3%" }}
        >
          Add Fields
        </button>
      </div>
      ...
      >
        <div
          ...
          onClick={fetchdatabystage_incoming}
        >
          <h6>INCOMING</h6>
          <p>{countincoming}</p>
        </div>
        <div
          ...
          onClick={fetchdatabystage_prospect}
        >
          <h6>PROSPECT</h6>
          <p>{countprospect}</p>
        </div>
        <div
          ...
          onClick={fetchdatabystage_opportunity}
        >
          <h6>OPPORTUNITY</h6>
        ...
        <div
          ...
          onClick={fetchdatabystage_Negotiation}
        >
          <h6>NEGOTIATION</h6>
        ...
        >
          ...
          <ul class="dropdown-menu">
            ...
            <li className="form-control">
              Lost{" "}
              <span
                style={{ fontSize: "30px", color: "red", fontWeight: "bolder" }}
              >
                <sup>{countlost}</sup>
              </span>
            </li>
        ...
        >
          ...
          <Tooltip title="Edit Data.." arrow>
            <img
              ...
              onClick={() => navigate('/edit-lead', {state: selectedItems[0]})}
          ...
          <Tooltip title="Add to task.." arrow>
            <img
              ...
              onClick={() =>
                navigate("/tasksform", {
                  state: { selectedItem: selectedItems[0] },
                })
              }
      ...
      >
                    ...
                    .map((col) => (
                      <StyledTableCell
                        ...
                        style={{
                          padding: "10px",
                          cursor:
                            col.id === "matchingdeal" ? "pointer" : "default",
                          fontSize: "12px",
                        }}
                        onClick={
                          col.id === "matchingdeal"
                            ? () => handleMatchLeadClick(item)
                            : undefined
                        } // Handle click if it's 'matchlead'
                      >
                        {col.id === "budget" ? (
                          <>
                          ...
                          <>
                            {(() => {
                              ...
                              const callTasks = filteredTasks.filter(
                                (task) =>
                                  task.activity_type.toLowerCase() === "call"
                              );
                              const mailTasks = filteredTasks.filter(
                                (task) =>
                                  task.activity_type.toLowerCase() === "mail"
                              );
                              const meetingTasks = filteredTasks.filter(
                                (task) =>
                                  task.activity_type.toLowerCase() === "meeting"
                              );
                              const sitevisitTasks = filteredTasks.filter(
                                (task) =>
                                  task.activity_type.toLowerCase() ===
                                  "sitevisit"
                              );
                          ...
                          (() => {
                            ...
                            if (!latestActivity)
                              return <span>No communication yet</span>;
        ...
        >
          ...
          <h6 style={{ lineHeight: "50px" }}>
            Total Lead-{" "}
            <span style={{ color: "green", fontSize: "12px" }}>{countall}</span>
          </h6>
          <h6 style={{ lineHeight: "50px" }}>
            Untouched Lead-{" "}
          ...
          <h6 style={{ lineHeight: "50px" }}>
            No Followups Lead-{" "}
            <span style={{ color: "gray", fontSize: "12px" }}>{countall}</span>
          </h6>
          <h6 style={{ lineHeight: "50px" }}>
            Returning Lead-{" "}
            <span style={{ color: "black", fontSize: "12px" }}>{countall}</span>
          </h6>
          <h6 style={{ lineHeight: "50px" }}>
            Returning No Followup Lead-{" "}
            <span style={{ color: "#D11414", fontSize: "12px" }}>
              {countall}
            </span>
          </h6>
          <h6 style={{ lineHeight: "50px" }}>
            Over Due Task Lead-{" "}
            <span style={{ color: "#04A9A9", fontSize: "12px" }}>
              {countall}
            </span>
          </h6>
          <h6 style={{ lineHeight: "50px" }}>
            Unassigned Lead-
            <span style={{ color: "#A90490", fontSize: "12px" }}>
              {countall}
            </span>
          </h6>
        </footer>
        ...
        <Modal.Body>
          ...
          <div className="row mt-3" id="leadinfobasic2">
            <div className="col-md-4">
              ...
              {leadinfo.country_code.map((item, index) => (
                <select
                  ...
                  required="true"
                  className="form-control form-control-sm"
                  onChange={(event) => handlecountry_codechange1(index, event)}
                >
            ...
            <div className="col-md-10">
              <label className="labels">Descriptions</label>
              <textarea
                defaultValue={leadinfo?.descriptions || ""}
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, descriptions: e.target.value })
                }
              />
            </div>
            ...
            <div className="col-md-6">
              <label className="labels">Lead Type</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-6">
              <label className="labels">Owner</label>
            ...
            <div className="col-md-6">
              <label className="labels">Visible to</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-6">
              <label className="labels">Campaign</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-6">
              <label className="labels">Source</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-6">
              <label className="labels">Sub-Source</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            {(leadinfo.source === "Reference" ||
              ...
              <>
                <div className="col-md-5">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setleadinfo({
                        ...leadinfo,
                        channel_partner: e.target.value,
                      })
                    }
                  >
                    <option>
                      {leadinfo?.channel_partner || "---Select---"}
                    </option>
                ...
                <div className="col-md-1" onClick={handleShow1}>
                  <label className="labels">Add</label>
                  <button className="form-control form-control-sm">+</button>
                </div>
              </>
            )}
          ...
          >
            <div className="col-md-3">
              <label className="labels">Requirment</label>
              <select
                className="form-control form-control-sm"
                required="true"
                onChange={(e) =>
            ...
            <div className="col-md-3">
              <label className="labels">Property Type</label>
            ...
            <div className="col-md-4">
              <label className="labels" style={{ display: "inline-block" }}>
                Purpose
              </label>
              <br></br>
              <input
            ...
            <div className="col-md-2">
              <label className="labels">NRI</label>
              <br></br>
              <input
                type="checkbox"
                value={"Yes"}
            ...
            <div className="col-md-6">
              <label className="labels">Sub Type</label>
            ...
            {leadinfo.requirment === "Buy" && (
              <>
                <div id="buybudgetmin" className="col-md-6">
                  <label className="labels">Budget Min</label>
                  <select
                    className="form-control form-control-sm"
                    onChange={(e) =>
                ...
                <div id="buybudgetmax" className="col-md-6">
                  <label className="labels">Budget Max</label>
                  <select
                    className="form-control form-control-sm"
                    onChange={(e) =>
            ...
            <div className="col-md-4">
              <label className="labels">Minimum Area</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, minimum_area: e.target.value })
                }
              >
            ...
            <div className="col-md-4">
              <label className="labels">Maximum Area</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, maximum_area: e.target.value })
                }
              >
            ...
            <div className="col-md-4">
              <label className="labels">Area Metric</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, area_metric: e.target.value })
                }
              >
            ...
            >
              ...
              >
                <div className="col-md-5">
                  ...
                  <select
                    className="form-control form-control-sm"
                    onChange={(e) =>
                      setleadinfo({ ...leadinfo, country3: e.target.value })
                    }
                  >
                    <option>India</option>
                ...
                <div className="col-md-5">
                  ...
                  >
                    ...
                    <MenuItem value="select-all">
                      <Checkbox
                        checked={
                          leadinfo.area_project.length === allproject.length
                        }
                      />
                    ...
                    {allproject.map((project) => (
                      <MenuItem key={project} value={project}>
                        <Checkbox
                          checked={leadinfo.area_project.indexOf(project) > -1}
                        />
                ...
                <div className="col-md-5">
                  ...
                  >
                    ...
                    <MenuItem value="select-all">
                      <Checkbox
                        checked={leadinfo.block3.length === allblocks.length}
                      />
                      <ListItemText primary="--- Select All ---" />
                    </MenuItem>
                    ...
                    {[
                      ...
                      >
                        <Checkbox
                          checked={
                            leadinfo.block3.indexOf(project.block_name) > -1
                          }
                        />
                ...
                <div className="col-md-5">
                  <label className="labels">Specific Unit</label>
                  <input
                    type="text"
                    className="form-control form-control-sm"
                    onChange={(e) =>
              ...
              <div
                className="row"
                id="search_location1"
                style={{ margin: "5px", padding: "10px", display: "none" }}
              >
                <div className="col-md-8">
                  <label className="labels">Search Location</label>
                  <input
                    type="text"
                    className="form-control form-control-sm"
                    ref={inputRef}
                ...
                <div className="col-md-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setleadinfo({ ...leadinfo, pincode2: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="col-md-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setleadinfo({ ...leadinfo, country2: e.target.value })
                    }
                  />
                </div>
                <div className="col-md-3">
                ...
                <div className="col-md-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setleadinfo({ ...leadinfo, lattitude: e.target.value })
                    }
                  />
                </div>
                <div className="col-md-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setleadinfo({ ...leadinfo, longitude: e.target.value })
                    }
                  />
                </div>
            ...
            <div className="col-md-4">
              <label className="labels">Funding</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-4">
              <label className="labels">Timeline</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-4">
              <label className="labels">Furnishing</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
            ...
            <div className="col-md-4">
              <label className="labels">Property Unit Type</label>
              <Select
                className="form-control form-control-sm"
                style={{ border: "none" }}
                multiple
              ...
              >
                ...
                <MenuItem value="select-all">
                  <Checkbox
                    checked={
                      propertyunitstypes.length === propertyunittype.length
                    }
                  />
                  <ListItemText
            ...
            <div className="col-md-4">
              ...
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, transaction_type: e.target.value })
                }
              >
            ...
            <div className="col-md-4">
              <label className="labels">Send Matched Deal</label>
              <Select
                className="form-control form-control-sm"
                style={{ border: "none" }}
                multiple
                value={
                  leadinfo.matched_deal ? leadinfo.matched_deal : matchdeals
                }
          ...
          >
            <div className="col-md-5">
              <label className="labels">Profession Category</label>
              <select
                className="form-control form-control-sm"
                onChange={handleProfessionCategoryChange}
              >
                <option>
                  {leadinfo?.profession_subcategory || "---Select---"}
                </option>
            ...
            <div className="col-md-7">
              <label className="labels">Profession Sub-Category</label>
              <select
                className="form-control form-control-sm"
            ...
            <div className="col-md-6">
              ...
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, company_name: e.target.value })
                }
              >
          ...
          >
            <div className="col-md-12">
              <label className="labels">Father/Husband name</label>
              <input
                type="text"
                className="form-control form-control-sm"
                defaultValue={data1.father_husband_name}
                onChange={(e) =>
                  setleadinfo({
                    ...leadinfo,
            ...
            <div className="col-md-3">
              <label className="labels">H.No</label>
              <input
                type="text"
                className="form-control form-control-sm"
                defaultValue={data1.h_no}
                onChange={(e) =>
            ...
            <div className="col-md-7">
              <label className="labels">Maritial Status</label>
              <select
                className="form-control form-control-sm"
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, maritial_status: e.target.value })
                }
              >
            ...
            <div className="col-md-7">
              <label className="labels">Anniversary Date</label>
              <input
                type="text"
                className="form-control form-control-sm"
                defaultValue={data1.anniversary_date}
                onChange={(e) =>
                  setleadinfo({ ...leadinfo, anniversary_date: e.target.value })
                }
              />
            </div>
                    ...
                    <div key={index} style={{ marginTop: "10px" }}>
                      ...
                      >
                        ...
                        <optgroup label="Bachelor’s ">
                          ...
                          <option>Bachelor of Engineering (BE or BEng) </option>
                          <option>Bachelor of Science in Nursing (BSN)</option>
                          <option>B.Bachelor of Laws (LLB) </option>
                          <option>B.Bachelor of Architecture (BArch)</option>
                        ...
                        <optgroup label="Master’s ">
                          ...
                          <option>Master of Engineering (ME or MEng)</option>
                        ...
                        <optgroup label="Doctoral ">
                          ...
                          <option>Doctor of Engineering (EngD or DEng) </option>
            ...
            <div className="col-md-4">
              <label className="labels">School/College/University</label>
            ...
            <div className="col-md-1">
              <label className="labels">add</label>
              <button className="form-control form-control-sm" onClick={addFn4}>
                +
              </button>
            </div>
            ...
            <div className="col-md-4">
              ...
              {Array.isArray(leadinfo.loan)
                ? leadinfo.loan.map((item, index) => (
                    ...
                    >
                      <option>{leadinfo.loan[index]}</option>
                      <option>Select</option>
            ...
            <div className="col-md-3">
              <label className="labels">Bank</label>
              {Array.isArray(leadinfo.bank)
                ? leadinfo.bank.map((item, index) => (
                    ...
                    >
                      ...
                      <option>UBS</option>
                      <option>Nabard Financial Services Ltd. (NABARD)</option>
                      <option></option>
                      ...
                      <option>The Maharashtra State Cooperative Bank </option>
                      ...
                      <option></option>
                      <option>Export-Import Bank of India (EXIM Bank) </option>
                      <option>
            ...
            <div className="col-md-1">
              <label className="labels">add</label>
              <button className="form-control form-control-sm" onClick={addFn5}>
                +
              </button>
            </div>

            <div className="col-md-4">
              <label className="labels">Social Media</label>
            ...
            <div className="col-md-1">
              <label className="labels">add</label>
              <button className="form-control form-control-sm" onClick={addFn6}>
                +
              </button>
            </div>

            <div className="col-md-4">
              <label className="labels">Income</label>
            ...
            <div className="col-md-1">
              <label className="labels">add</label>
              <button className="form-control form-control-sm" onClick={addFn7}>
                +
              </button>
            </div>

            <div className="col-md-3">
              <label className="labels">Document No.</label>
            ...
            <div className="col-md-1">
              <label className="labels">add</label>
              <button className="form-control form-control-sm" onClick={addFn8}>
                +
              </button>
            </div>
          </div>
    ...
    <div className="col-md-12"><hr></hr></div>
        ...
        <ul>
          {attachments.length > 0 && attachments.map((file, index) => (
            ...
            >
              ...
              >
                <label className="labels" style={{ fontSize: "12px" }}>
                  Templates
                </label>
                <select
                  type="text"
      ...
      <Modal show={show5} onHide={handleClose5} size="lg">
        ...
        <Modal.Body>
            ...
            >
              {leaddata.owner?.map((owner, index) => (
                <MenuItem key={index} value={owner}>
                  <Checkbox checked={owners1.indexOf(owner) > -1} />{" "}
          ...
          <div className="col-md-6">
            <label className="labels">Lead Stage</label>
            <select
              className="form-control form-control-sm"
              onChange={(e) => setupdatestage(e.target.value)}
            >
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              className="form-control form-control-sm"
              style={{ height: "100px" }}
              placeholder={leaddata.descriptions}
              ...
              {Array.isArray(leaddocument.document_no)
                ? leaddocument.document_no.map((item, index) => (
                    <input
                      ...
                      className="form-control form-control-sm"
                      onChange={(event) =>
                        handledocumentnochange1(index, event)
                      }
                    />
                  ))
                : []}
              ...
              {Array.isArray(leaddocument.document_name)
                ? leaddocument.document_name.map((item, index) => (
                    <select
                      ...
                      style={{ marginTop: "10px" }}
                      onChange={(event) =>
                        handledocumentnamechange1(index, event)
                      }
                    >
              ...
              {Array.isArray(leaddocument.document_pic)
                ? leaddocument.document_pic.map((pic, index) => (
                    <input
                      ...
                      className="form-control form-control-sm"
                      onChange={(event) =>
                        handledocumentpicchange1(index, event)
                      }
                    />
                  ))
                : []}
      ...
      >
        <Modal.Header>
          <Modal.Title>
            Matched Deals for<br></br>
            <span
              style={{ color: "blue", fontWeight: "normal", fontSize: "16px" }}
            >
              {displaylead?.title} {displaylead?.first_name}{" "}
              {displaylead?.last_name}
            </span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
                      ...
                      .map((col) => (
                        ...
                        >
                          {col.id === "budget" ? (
                            <>
                              Min: ₹
                              {Number(item.budget_min)?.toLocaleString("en-IN")}
                              /- <br />
                              Max: ₹
                              {Number(item.budget_max)?.toLocaleString("en-IN")}
                              /-
                            </>
                          ) : col.id === "requirment" ? (
                            <>
                              ...
                              item?.unit_type?.length > 0 ||
                              item?.sub_type?.length > 0
                                ? (item?.property_type?.length > 0
                                    ? item.property_type
                                    : [""]
                                  ).map((ptype, pIndex) =>
                            ...
                            <>
                              Min:{item.minimum_area} {item.area_metric}
                              <br />
                        ...
                        .map((col) => (
                          ...
                          >
                            {col.id === "score" ? (
                              ...
                              <>
                                {unitDataMap[item._id]?.owner_details?.length >
                                0
                                  ? unitDataMap[item._id].owner_details.map(
                                      (owner, index) => (
                                        <div
                                          key={index}
                              ...
                              <>
                                ₹
                                {Number(item.expected_price)?.toLocaleString(
                                  "en-IN"
                                )}
                                /-
                              </>
          ...
          {relateddeals.length > 0 && (
            <>
              <h5 style={{ marginLeft: "35%", marginTop: "20px" }}>
                Others Category's Related Deals:
              </h5>
                              ...
                              .map((col) => (
                                ...
                                >
                                  {col.id === "score" ? (
                                    ...
                                    <>
                                      {unitDataMap[item._id].category.join(
                                        ","
                                      ) || "Loading..."}
                                    </>
                                  ) : col.id === "size" ? (
                                    <>
                                      {unitDataMap[item._id].size ||
                                        "Loading..."}
                                    </>
                                  ) : col.id === "owner" ? (
                                    <>
                                      {unitDataMap[item._id]?.owner_details
                                        ?.length > 0
                                        ? unitDataMap[
                                            item._id
                                          ].owner_details.map(
        ...
        <Modal.Body>
          ...
          >
            ...
            >
              ...
              >
                ...
                <select
                  ...
                  onChange={handleTemplateSelect1}
                  style={{ fontSize: "12px" }}
                >
                  <option value="">---Select Template---</option>
                  <option value="template1">Template 1</option>
            ...
            >
              ...
              <div className="col-md-4">
                <label className="labels">Choose Whatsapp Number</label>
                <select
                  className="form-control form-control-sm"
                  onChange={(e) => setinstanceId(e.target.value)}
                >
                  <option>---select---</option>
                  <option value={firstuser}>
                    9991333570(Bharat Properties)
                  </option>
                  <option value={seconduser}>
                    9991000570(Bharat Properties2)
                  </option>
                </select>
              </div>
          ...
          <div className="row">
            ...
            >
              ...
              <select
                ...
                className="form-control form-control-sm"
                style={{ fontSize: "12px" }}
                onChange={(e) => setviewconditon(e.target.value)}
              >
            ...
            <div
              ...
              style={{
                ...
                border: "1px solid gray",
                padding: "10px",
                display: viewcondition == "Lead Source" ? "flex" : "none",
              }}
            >
              <div
                className="col-md-6"
            ...
            <div
              ...
              style={{
                ...
                border: "1px solid gray",
                padding: "10px",
                display: viewcondition == "Lead Transfer" ? "flex" : "none",
              }}
            >
              <div
                className="col-md-6"
              ...
              >
                <input name="selecthistory" type="radio" />
                <span style={{ marginLeft: "10px" }}>With History</span>
                <input
                  name="selecthistory"
                  type="radio"
                  style={{ marginLeft: "40px" }}
                />
                <span style={{ marginLeft: "10px" }}>Without History</span>
                <input
                  name="selecthistory"
                  type="radio"
                  style={{ marginLeft: "40px" }}
                ...
                <span style={{ marginLeft: "10px" }}>
                  Without History and New Status
                </span>
              </div>
                ...
                <div className="mt-6 bg-gray-100 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <button
                      className="form-control form-control-sm"
                      style={{ width: "200px" }}
                      onClick={updatecontactforbulkupload}
                    >
                      🔄 Update Leads
                    </button>
                  </div>
