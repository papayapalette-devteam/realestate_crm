...
useEffect(() => {
  const updateLeadsAndRefresh = async () => {
    ...
    try {
      ...
      await fetchdata(currentPage, itemsPerPage, activeFilters, logged_user?.name);
     ...
     useEffect(() => {
      get_group_data();
        ...
        const contactfields = [
          ...
          { label: 'Requirement', field: 'requirment',values: groupdata?.requirements },
          ...
          { label: 'Channel Partner', field: 'channel_partner',values: groupdata?.channel_partners }
