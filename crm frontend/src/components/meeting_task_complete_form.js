...
function Meeting_task_complete_form() {
            ...
            <div className="p-3 py-5">
                ...
                <div className="row mt-2">
                    ...
                    <option>Select</option>
                        ...
                        <div className="col-md-4"><label className="labels">Meeting Result</label><select className="form-control" required="true" >
                    <option>Select</option>
                        {
                            result.map(item=>
                                (
...
export default Meeting_task_complete_form;