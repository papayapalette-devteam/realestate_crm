...
import image from "../components/Assests/loginimage.png";
...
const login = async (e) => {
  ...
  return (
    // <div className="min-h-screen flex flex-col md:flex-row bg-gray-50"  style={{ backgroundImage: `url(${image})` }}>
    ...
    <div className="relative min-h-screen flex items-center justify-start overflow-hidden">
      ...
      <img
        src={image}
        alt="Background"
        className="absolute inset-0 w-full h-full object-fill" // 👈 use object-fill to stretch full width & height
      />
      ...
      {/* Login form */}
      <div className="relative z-10 w-full max-w-md p-8 ml-2 md:ml-20">
