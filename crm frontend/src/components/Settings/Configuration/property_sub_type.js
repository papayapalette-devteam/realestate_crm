...
function PropertySubType() {
  ...
  const onEdit = (row) => {
    ...
    setProperty_Sub_Type({
      property_sub_type: row.lookup_value,
      property_type: row.parent_lookup_value,
    });
  };
  ...
  const onDelete = async (row) => {
    try {
      const confirmResult = await Swal.fire({
        title: "Are you sure?",
        text: "Do you really want to delete this Property Sub Type?",
        icon: "warning",
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            icon: "success",
            title: "Property Sub Type Deleted",
            text: "Property Sub Type Deleted Successfully...",
  ...
  const allcolumns = [
    { id: "sno", name: "#" },
    { id: "parent_lookup_value", name: "Property Type" },
    { id: "lookup_value", name: "Property Sub Type" },
  ...
  const add_property_sub_type = async () => {
    try {
      setloading(true);
      const resp = await api.post("api/SaveLookup", {
        lookup_id: lookup_id ? lookup_id : null,
        lookup_type: "property_sub_type",
        lookup_value: Property_Sub_Type.property_sub_type,
        parent_lookup_value: Property_Sub_Type.property_type,
      });
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            icon: "success",
            title: "Property Sub Type Added",
            text: "Property Sub Type Added Successfully...",
            showConfirmButton: true,
            customClass: {
              popup: "small-swal-popup",
              confirmButton: "my-swal-button",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            <h3 className="text-2xl font-bold text-gray-800">
              Enter Details for Property Sub Type
            </h3>
            <p className="text-gray-500 mt-1">
              Add or update the required details of property sub type to keep records
              accurate.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  defaultValue={Property_Sub_Type.property_sub_type}
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    type="text"
                    name="property_type"
                    defaultValue={Property_Sub_Type.property_type}
                    onChange={handlechange}
                    onClick={() => {
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <div className="overflow-auto max-h-[700px]">
              <table className="min-w-full text-left border-collapse">
                ...
                <tbody>
                  {All_Property_Sub_Type?.map((item, index) => (
                    <tr
                      key={index}
