...
function CountryCode() {
  ...
  const onDelete = async (row) => {
    try {
      const confirmResult = await Swal.fire({
        title: "Are you sure?",
        text: "Do you really want to delete this Country Code?",
        icon: "warning",
  ...
  const allcolumns = [
    { id: "sno", name: "#" },
    { id: "lookup_value", name: "Country Code" },
  ...
  const add_country_code = async () => {
    try {
      setloading(true);
      const resp = await api.post("api/SaveLookup", {
        lookup_id: lookup_id ? lookup_id : null,
        lookup_type: "country_code",
        lookup_value: Country_Code.country_code,
      });
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            ...
            text: "Country Code Added Successfully...",
            showConfirmButton: true,
            customClass: {
              popup: "small-swal-popup",
              confirmButton: "my-swal-button",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            <h3 className="text-2xl font-bold text-gray-800">
              Enter Details for Country Code
            </h3>
            <p className="text-gray-500 mt-1">
              Add or update the required details of country code to keep records
              accurate.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="country_code"
                  defaultValue={Country_Code.country_code}
