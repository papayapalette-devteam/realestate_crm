...
function City() {
  ...
  const onEdit = (row) => {
    ...
    setCity({
      city: row.lookup_value,
      state: row.parent_lookup_value,
    });
  };
  ...
  const allcolumns = [
    { id: "sno", name: "#" },
    { id: "parent_lookup_value", name: "State" },
    { id: "lookup_value", name: "City" },
  ...
  const add_city = async () => {
    try {
      ...
      const resp = await api.post("api/SaveLookup", {
        ...
        lookup_type: "city",
        lookup_value: City.city,
        parent_lookup_value: City.state,
      });
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            <h3 className="text-2xl font-bold text-gray-800">
              Enter Details for City
            </h3>
            <p className="text-gray-500 mt-1">
              Add or update the required details of city to keep records
              accurate.
            </p>
          </div>
