...
function Direction() {
  ...
  const onDelete = async (row) => {
    try {
      const confirmResult = await Swal.fire({
        title: "Are you sure?",
        text: "Do you really want to delete this Direction?",
        icon: "warning",
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            icon: "success",
            title: "Direction Deleted",
            text: "Direction Deleted Successfully...",
  ...
  const allcolumns = [
    { id: "sno", name: "#" },
    { id: "lookup_value", name: "Direction" },
  ...
  const add_direction = async () => {
    try {
      setloading(true);
      const resp = await api.post("api/SaveLookup", {
        lookup_id: lookup_id ? lookup_id : null,
        lookup_type: "direction",
        lookup_value: Direction.direction,
      });
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            ...
            text: "Direction Added Successfully...",
            showConfirmButton: true,
            customClass: {
              popup: "small-swal-popup",
              confirmButton: "my-swal-button",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            <h3 className="text-2xl font-bold text-gray-800">
              Enter Details for Direction
            </h3>
            <p className="text-gray-500 mt-1">
              Add or update the required details for direction to keep records
              accurate.
            </p>
          </div>
