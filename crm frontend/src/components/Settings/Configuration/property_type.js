...
function PropertyType() {
  ...
  const onEdit = (row) => {
    ...
    setProperty_Type({
      property_type: row.lookup_value,
    });
  };
  ...
  const allcolumns = [
    { id: "sno", name: "#" },
    { id: "lookup_value", name: "Property Type" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            <h3 className="text-2xl font-bold text-gray-800">
              Enter Details for Property Type
            </h3>
            <p className="text-gray-500 mt-1">
              Add or update the required details for property type to keep records
              accurate.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="property_type"
                  defaultValue={Property_Type.property_type}
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <div className="overflow-auto max-h-[700px]">
              <table className="min-w-full text-left border-collapse">
                ...
                <tbody>
                  {All_Property_Type.map((item, index) => (
                    <tr
                      key={index}
