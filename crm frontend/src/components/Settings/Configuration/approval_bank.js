  ...
  const onDelete = async (row) => {
    try {
      const confirmResult = await Swal.fire({
        title: "Are you sure?",
        text: "Do you really want to delete this Bank?",
        icon: "warning",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" p-6 mb-2">
            ...
            <p className="text-gray-500 mt-1">
              Add or update the required details for bank to keep records
              accurate.
            </p>
          </div>
