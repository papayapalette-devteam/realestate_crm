...
const {add_contact,view_contact, view_contact_Byid, remove_contact, update_contact, view_contact_Byemail, view_contact_Bymobile, view_contact_Bytags, view_contact_Bycompany, view_contact_ByName, update_contactsingledocument, delete_contactsingledocument, add_contactdocument, addbulkcontacts, update_contactforbulkupload, searchcontact, view_contact_for_editproject, getGroupedData} = require('../controllers/contact_details');
...
const {createProject,view_project, view_projectbyname, view_projectbycityname, remove_project, view_project_Byid, update_project, view_projectforinventories, update_projectforinventories, update_projectaddunit, delete_projectforinventories, update_projectforinventoriesbulk, view_units, view_projectforadddeal, getGroupedDataproject} = require('../controllers/project');
...
const { view_followup_task, view_sitevisit_task, view_meeting_task } = require('../controllers/all_task_list');
