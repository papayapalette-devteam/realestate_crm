...
const blockSchema = new mongoose.Schema({
  ...
  const unitschema = new mongoose.Schema({
    ...
    size_breadth:{type: String},
    size_unit:{type: String},
    size_total_area:{type: String},
    size_total_area_unit:{type: String},
    land_type:{type: String},
    khewat_no:{type: Array},
    killa_no:{type: Array},
    share:{type: Array},
    total_land_area:{type: String},
    water_source:{type: Array},
    water_level:{type: Array},
    water_pump_type:{type: Array},
    direction: {type: String},
    side_open: {type: String},
    fornt_on_road: {type: String},
    total_owner: {type: String},
    facing: {type: String},
    road: {type: String},
    ownership: {type: String},
    stage: {type: String,enum: ["Active", "Inactive"],default: "Inactive"},
